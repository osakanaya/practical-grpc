...
public class CancellationServer1 {
	private static final Logger logger = Logger.getLogger(CancellationServer1.class.getName());

	private final int port;
	private final Server server;

	public CancellationServer1(int port) throws IOException {
		this(ServerBuilder.forPort(port), port);
	}

	public CancellationServer1(ServerBuilder<?> serverBuilder, int port) {
		this.port = port;
	...
	public static void main(String[] args) throws Exception {
		CancellationServer1 server = new CancellationServer1(8080);
		server.start();

...
public final class ProtectedResourceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest,
      uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse> getGetDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetData",
      requestType = uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest.class,
      responseType = uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest,
      uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse> getGetDataMethod() {
    io.grpc.MethodDescriptor<uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest, uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse> getGetDataMethod;
    if ((getGetDataMethod = ProtectedResourceGrpc.getGetDataMethod) == null) {
      synchronized (ProtectedResourceGrpc.class) {
        if ((getGetDataMethod = ProtectedResourceGrpc.getGetDataMethod) == null) {
          ProtectedResourceGrpc.getGetDataMethod = getGetDataMethod = 
              io.grpc.MethodDescriptor.<uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest, uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "ch7.ex3.ProtectedResource", "GetData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new ProtectedResourceMethodDescriptorSupplier("GetData"))
                  .build();
          }
        }
     }
  ...
  public static abstract class ProtectedResourceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getData(uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest request,
        io.grpc.stub.StreamObserver<uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest,
                uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse>(
  ...
  public static final class ProtectedResourceBlockingStub extends io.grpc.stub.AbstractStub<ProtectedResourceBlockingStub> {
    ...
    /**
     */
    public uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse getData(uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest request) {
  ...
  public static final class ProtectedResourceFutureStub extends io.grpc.stub.AbstractStub<ProtectedResourceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse> getData(
        uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATA:
          serviceImpl.getData((uk.me.uohiro.protobuf.model.ch7.ex3.GetDataRequest) request,
              (io.grpc.stub.StreamObserver<uk.me.uohiro.protobuf.model.ch7.ex3.GetDataResponse>) responseObserver);
          break;
        default:
